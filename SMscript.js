    ...
    shareButton.addEventListener('click', async () => {
        try {
            await navigator.share({
                text: 'Visit MasterixMusic\'s page here:',
                url: 'https://mcc-masterix.github.io/masterixmusicsocialplatforms/'
            });
...
let content = 'Visit MasterixMusic\'s page here:';
let link = 'https://mcc-masterix.github.io/masterixmusicsocialplatforms/';
...
//Redirects
document.getElementById('checkmtx666').addEventListener('click', function(){
    open('https://mcc-masterix.github.io/mtx666socialplatforms/');
});
